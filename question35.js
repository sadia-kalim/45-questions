...
//Animals
var animalsCommonCharacteristic = ["Dog", "Cat", "Lion"];
//Print the name of each animal in list
for (var i = 0; i < animalsCommonCharacteristic.length; i++) {
    console.log("".concat(animalsCommonCharacteristic[i]));
}
//Print a Statement for each animal
for (var i = 0; i < animalsCommonCharacteristic.length; i++) {
    console.log("A ".concat(animalsCommonCharacteristic[i], " Would a great pet"));
}
//Printing Statement about these animals have common
console.log("All of these animals share the common characteristic of motility, which means they\n   are capable of moving independently.");
